...
@Entity
@Table(name = "na_tipo_logradouro", catalog = "", schema = "public")
public class NaTipoLogradouro implements Serializable {
	private static final long serialVersionUID = 1L;

	@Filter(name = "Código", simpleFilterMethod = EnumFilterMethod.EQUALS)
	@Id
	@SequenceGenerator(name = "genNaTipoLogradouro", allocationSize = 1, schema = "public", sequenceName = "seq_na_tipo_logradouro")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "genNaTipoLogradouro")
	@Column(name = "ID", nullable = true)
	private Integer id;

	@Filter(name = "Abreviatura", simpleFilterMethod = EnumFilterMethod.LIKE)
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		NaTipoLogradouro other = (NaTipoLogradouro) obj;
		if (id == null) {
			if (other.id != null)
				return false;
