...
/**
 * Método para escrever um numero por extenso
 * 
 * Como testar: 
 * Extenso teste = new Extenso(new BigDecimal(args[0]));
 * log.debug("Numero  : " + (new DecimalFormat().format(Double.valueOf(args[0]))));
 * log.debug("Extenso : " + teste.toString());
 * 
...
public class Extenso {
	...
	private static final Log log = LogFactory.getLog(Extenso.class);
