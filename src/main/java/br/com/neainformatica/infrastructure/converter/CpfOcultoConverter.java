...
@FacesConverter("cpfOcultoConverter")
public class CpfOcultoConverter implements javax.faces.convert.Converter {
	...
	public String getAsString(FacesContext facesContext, UIComponent uiComponent, Object objeto) {
		...
		try {
			if (objeto != null) {
				return NeaFormatter.gerarStringOcultaCPF((String) objeto);
			} else {
				return null;
			}
		} catch (Exception e) {
