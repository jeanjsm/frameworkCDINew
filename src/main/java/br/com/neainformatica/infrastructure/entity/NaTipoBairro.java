...
@Entity
@Table(name = "na_tipo_bairro", catalog = "", schema = "public")
public class NaTipoBairro implements Serializable {
	private static final long serialVersionUID = 1L;

	@Filter(name = "Código", simpleFilterMethod = EnumFilterMethod.EQUALS)
	@Id
	@SequenceGenerator(name="genNaTipoBairro", allocationSize = 1, schema="public", sequenceName = "seq_na_tipo_bairro")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator="genNaTipoBairro" )
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		NaTipoBairro other = (NaTipoBairro) obj;
		if (id == null) {
			if (other.id != null)
				return false;
