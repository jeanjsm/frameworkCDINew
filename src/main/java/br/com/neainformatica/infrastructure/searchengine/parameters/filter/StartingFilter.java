 ...
 * @see IFilter
 * */
public class StartingFilter extends GenericFilter implements IFilter {
	 ...
	 * */
	public StartingFilter(String field, Object initialValue, String alias) {
		super(field, initialValue, alias);
		this.setFilterBy(FilterEnum.STARTING);
	}
